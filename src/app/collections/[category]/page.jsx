...
const CATEGORY_MAP = {
  'matching-moods': {
    ...
    description: 'An exploration of curated silhouettes, blending contemporary tailored elegance with heritage printing traditions. Structured blazers, relaxed dhoti sets, and statement co-ords designed to reflect and elevate your everyday consciousness.',
  },
  'flow-state': {
    title: 'Flow State',
    ...
    description: 'Embrace absolute freedom of movement. Oversized kaftans, fluid dresses, and drape layers crafted with fine conscious luxury textiles that flow effortlessly with every step.',
  },
  'power-layers': {
    title: 'Power Layers',
    ...
    description: 'Structure meets handcrafted artistry. Elegant Nehru jackets, long blazers, and heritage waistcoats adorned with subtle, sophisticated phulkari and hand embroideries.',
  },
  'six-yards-of-good': {
    ...
    description: 'Indian tradition re-imagined. Exquisitely light sarees featuring bespoke digital print margins, delicate lace borders, and breathable fabrics designed for contemporary comfort.',
  },
  'custom-made-for-moments': {
    ...
    description: 'Custom luxury tailored for lifetime memories. Impeccable hand-embroidered lehengas, bespoke sherwanis, and occasion statements custom crafted with organic vegan silks.',
  },
  'natural-luxury': {
    ...
    description: 'Earthy luxury tailored to perfection. Breathable linen shirts, drop-shoulder hemp silhouettes, and organic muslin clothing featuring fine hand-stitched detailing.',
  },
  'printed-stories': {
    ...
    description: 'Unstructured contemporary statements. Boxy fit drop-shoulder shirts showcasing custom motifs, bold printed canvases, and breathable fabrics.',
  },
  'modern-classics': {
    ...
    description: 'Timeless menswear honoring heritage Punjab craftsmanship. Exquisite Phulkari bundis and premium jute-cotton shirts reimagined for the modern gentleman.',
  },
};
